...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weatherprojectnamespace.servicebus.windows.net" 
    ...
    def fetch_weather_data():
        ...
        location = "New Haven"  # You can replace with any city name based on your preference

        # Fetch the API key from Key Vault
        VAULT_URL = "https://weather-project-keyvault.vault.azure.net/"
